...
public class LocalHost
{
        ...
        public LocalHost(string url)
        {
                ...
                try{
                        ...
                        UnityEngine.Debug.Log(string.Format("Error in new SocketIO:{0}", e.Message));
                }
        ...
        private void sendMessage(int reqId, string route, JsonObject msg){
                ...
                try{
                        ...
                        UnityEngine.Debug.Log(string.Format("Error in protocol.encode:{0}", e.Message));
                }
        ...
        private void SocketOpened (object sender, EventArgs e){
                UnityEngine.Debug.Log("The socketIO opend!");
        }
        /// <summary>
